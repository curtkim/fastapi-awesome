...
description = """
fastapi_awesome API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_awesome",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_awesome.com/terms/",
    contact={
        "name": "curtkim",
        "url": "http://fastapi_awesome.com/contact/",
        "email": "curtkim@fastapi_awesome.com",
    },
    license_info={
        "name": "The Unlicense",
