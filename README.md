...
- 🎯 Entry points to execute your program using `python -m <fastapi_awesome>` or `$ fastapi_awesome` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/curtkim/fastapi-awesome/branch/main/graph/badge.svg?token=fastapi-awesome_token_here)](https://codecov.io/gh/curtkim/fastapi-awesome)
[![CI](https://github.com/curtkim/fastapi-awesome/actions/workflows/main.yml/badge.svg)](https://github.com/curtkim/fastapi-awesome/actions/workflows/main.yml)

Awesome fastapi_awesome created by curtkim

## Install

from source
```bash
git clone https://github.com/curtkim/fastapi-awesome fastapi_awesome
cd fastapi_awesome
make install
```
...
```bash
pip install fastapi_awesome
```

## Executing

```bash
$ fastapi_awesome run --port 8080
```

or

```bash
python -m fastapi_awesome run --port 8080
```

or

```bash
$ uvicorn fastapi_awesome:app
```

## CLI

```bash
❯ fastapi_awesome --help
Usage: fastapi_awesome [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_awesome create-user --help
Usage: fastapi_awesome create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_awesome create-user admin admin --superuser
```
...
Run with `fastapi_awesome run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_awesome create-user`.
...
-----------------------------------------------------
fastapi_awesome/__init__.py              4      0   100%
fastapi_awesome/app.py                  16      1    94%
fastapi_awesome/cli.py                  21      0   100%
fastapi_awesome/config.py                5      0   100%
fastapi_awesome/db.py                   10      0   100%
fastapi_awesome/models/__init__.py       0      0   100%
fastapi_awesome/models/content.py       47      1    98%
fastapi_awesome/routes/__init__.py      11      0   100%
fastapi_awesome/routes/content.py       52     25    52%
fastapi_awesome/routes/security.py      15      1    93%
fastapi_awesome/routes/user.py          52     26    50%
fastapi_awesome/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_awesome/default.toml.
