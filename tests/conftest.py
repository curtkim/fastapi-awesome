...
# WARNING: Ensure imports from `fastapi_awesome` comes after this line
from fastapi_awesome import app, settings, db  # noqa
from fastapi_awesome.cli import create_user, cli  # noqa
